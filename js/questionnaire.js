...
$('.academics-number-button').on('click',function() {
    ...
    // if same button clicked twice consecutively, store 0 into academics_value
    if (academics_value == buttonClicked) {
        academics_value = 0;

    // else, store button value into academics_value
    } else {
...
$('.athletics-number-button').on('click',function() {
    ...
    // if same button clicked twice consecutively, store 0 into academics_value
    if (athletics_value == buttonClicked) {
        athletics_value = 0;
...
$('.leadership-number-button').on('click',function() {
    ...
    // if same button clicked twice consecutively, store 0 into academics_value
    if (leadership_value == buttonClicked) {
        leadership_value = 0;
...
$('.philanthropy-number-button').on('click',function() {
    ...
    // if same button clicked twice consecutively, store 0 into academics_value
    if (philanthropy_value == buttonClicked) {
        philanthropy_value = 0;
...
$(".academics-number-buttons button").click(function() {
    $('.academics-number-buttons .academics-number-button.selected').not(this).removeClass('selected');
    $(this).toggleClass('selected');
})

$(".athletics-number-buttons button").click(function() {
    $('.athletics-number-buttons .athletics-number-button.selected').not(this).removeClass('selected');
    $(this).toggleClass('selected');
})

$(".leadership-number-buttons button").click(function() {
    $('.leadership-number-buttons .leadership-number-button.selected').not(this).removeClass('selected');
    $(this).toggleClass('selected');
})

$(".social-number-buttons button").click(function() {
    $('.social-number-buttons .social-number-button.selected').not(this).removeClass('selected');
    $(this).toggleClass('selected');
})

$(".philanthropy-number-buttons button").click(function() {
    $('.philanthropy-number-buttons .philanthropy-number-button.selected').not(this).removeClass('selected');
    $(this).toggleClass('selected');
})
